...
const initApp = () => {
  ...
  const pathwayExplanations = {
    ...
    highrisk: "<p><strong>אשפוז במחלקת אם ועובר:</strong> המיילדת תכין אותך לאשפוז במחלקה, תרכיב עירוי ותיקח בדיקות דם. ברגע שחדר יתפנה עבורך, תוכלי לעלות למחלקה, שנמצאת בקומה 2.</p>",
