...
const initApp = () => {
  ...
  const pathwayExplanations = {
    observe: "<p><strong>המשך מעקב והשגחה במיון:</strong> במצב זה תתבקשי להישאר במיון יולדות להמשך טיפול קצר והשגחה של המיילדות כדי לוודא שהכל תקין לפני קבלת החלטה סופית.</p>",
    delivery: "<p><strong>מעבר לחדר לידה:</strong> המיילדת תכין אותך לחדר לידה, תרכיב עירוי ותיקח בדיקות דם. ברגע שחדר יתפנה עבורך, המיילדת תלווה אותך לחדר הלידה.</p>",
    highrisk: "<p><strong>אשפוז במחלקת היריון בסיכון:</strong> המיילדת תכין אותך לאשפוז במחלקה, תרכיב עירוי ותיקח בדיקות דם. ברגע שחדר יתפנה עבורך, תוכלי לעלות למחלקה, שנמצאת בקומה 2.</p>",
